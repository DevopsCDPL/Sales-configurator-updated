        ...
        <Box sx={{ p: c ? 1.5 : 2, display: 'flex', alignItems: 'center', justifyContent: c ? 'center' : 'space-between', minHeight: HEADER_HEIGHT }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, overflow: 'hidden', cursor: 'pointer', transition: 'opacity 0.2s ease', '&:hover': { opacity: 0.8 } }} onClick={() => handleNav('/')}>
            <Box sx={{
              ...
              <Typography sx={{ fontSize: 13, fontWeight: 800, color: '#06151c', letterSpacing: '-0.02em' }}>SC</Typography>
            </Box>
            {!c && (
              <Box sx={{ minWidth: 0 }}>
                      ...
                      sx={{
                        ...
                        ...(isActive('/procurement')
                          ...
                          : {
                              color: 'var(--text-secondary)',
                              opacity: 0.82,
                              '&:hover': { bgcolor: 'var(--bg-sidebar-active)', color: 'var(--text-primary)', opacity: 1 },
                            }),
                      }}
                    >
                      <ListItemIcon sx={{ minWidth: 0, justifyContent: 'center', color: isActive('/procurement') ? PRIMARY : 'var(--text-muted)', '& .MuiSvgIcon-root': { fontSize: 19 } }}>
                        <ShoppingCartIcon />
                      </ListItemIcon>
                    </ListItemButton>
                  </Tooltip>
                    ...
                    sx={{
                      ...
                      ...(isActive('/procurement')
                        ...
                        : {
                            color: 'var(--text-secondary)',
                            opacity: 0.82,
                            '&:hover': { bgcolor: 'var(--bg-sidebar-active)', color: 'var(--text-primary)', opacity: 1, transform: 'translateX(3px)' },
                          }),
                    }}
                  >
                    <ListItemIcon sx={{ minWidth: 34, justifyContent: 'center', color: isActive('/procurement') ? PRIMARY : 'var(--text-muted)', '& .MuiSvgIcon-root': { fontSize: 19 } }}>
                      <ShoppingCartIcon />
                    </ListItemIcon>
                    <ListItemText
                      primary="Procurement"
                      primaryTypographyProps={{
                        fontSize: '0.82rem',
                        fontWeight: isActive('/procurement') ? 650 : 450,
                        color: isActive('/procurement') ? PRIMARY : 'var(--text-primary)',
                        whiteSpace: 'nowrap',
                        letterSpacing: '-0.01em',
                      }}
                    />
          ...
          <Menu anchorEl={profileAnchor} open={Boolean(profileAnchor)} onClose={handleProfileClose}
            ...
            {editNameOpen && (
              <Box sx={{ px: 2.5, py: 1.5, display: 'flex', gap: 1, alignItems: 'center' }}>
                ...
                />
                <Button size="small" variant="contained" onClick={handleUpdateName} sx={{ minWidth: 0, px: 1.5, bgcolor: PRIMARY, '&:hover': { bgcolor: PRIMARY_DK }, textTransform: 'none', fontSize: '0.78rem', borderRadius: 2 }}>Save</Button>
              </Box>
            )}
